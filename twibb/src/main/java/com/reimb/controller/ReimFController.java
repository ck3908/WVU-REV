...
public class ReimFController extends DefaultServlet {
	private Logger log = Logger.getLogger(ReimFController.class);
	private ReqDispatcher rh = new ReqDispatcher();
